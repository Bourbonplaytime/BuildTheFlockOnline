...
<?php include("PHP_Includes/Header.php") ?>
  ...
  <body>
      ...
      <div>
        <p class="intro-text text-center">The time is approaching. Below is a countdown to this year's U of L @ UK football game.</p>

    <div class="countdown">
        <table class="center">
          <tr>
            <td colspan="4" class="countdown-title" style="text-align:center">Countdown to U of L @ UK football game.</td>
          </tr>
          <tr>
      ...
      <script type="text/javascript">
        ...
        function countdown(){
          var now = new Date();
          var eventDate = new Date(2019, 10, 30, 12)
      ...
      <div class="mid-section">
        <div class="BTFlogo2transform">
          ...
          <p class="intro-text"> I'm also in the planning stages of creating a #BTF presence for Instagram. It's always been part of my vision to expand this project beyond twitter and into other social media realms. It looks like Instagram may be next.</p>
